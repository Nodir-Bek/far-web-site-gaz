...
import PdfTemplate from "~/components/pdf-templates/getOne/index.vue";
...
const { data: otherData } = await NewsService.getNewsPaginate(query);
...
<template>
  <div class="pt-[40px] sm:pt-[47px] lg:pt-[60px]">
    ...
    >
      <div
        class="flex sm:flex-col gap-y-[20px] gap-x-[12px] sm:pr-[24px] lg:pr-[55px] lg:pl-[30px]"
      >
        <div
    ...
    <div
      class="bg-grey-background-color pb-[100px] pt-[60px] lg:pb-[140px] lg:pt-[80px]"
    >
      <div
