...
<template>
  <div class="w-full h-full flex flex-col justify-center items-center gap-5">
    <div
      class="relative flex items-center justify-between gap-3 w-full h-12 border rounded-lg border-secondary-bold px-4 py-2"
    >
      <input
        type="text"
    ...
    >
      ...
      <div v-else class="w-full h-full flex flex-col gap-4 px-4">
        ...
        >
          <svg
            class="svg-icon w-full max-w-[300px] h-full max-h-[400px]"
        ...
        <div
          v-else
          class="w-full flex flex-col gap-1 border-b border-secondary-bold/15 p-5"
...
<style scoped>
/* Qo'shimcha Tailwind CSS stil kodlari kerak bo'lsa */
</style>
